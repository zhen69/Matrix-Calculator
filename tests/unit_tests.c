...
Test(base_execute, script21) { run_script_without_valgrind("script21"); } 
Test(base_execute_valgrind, script21) { expect_no_valgrind_errors(run_script_with_valgrind("script21")); }